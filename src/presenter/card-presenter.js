...
import {Category, UserAction, ModelMethod, KeyboardKeyCodes} from "../data.js";
...
export default class CardPresenter {
  ...
  init(film, container = this._container) {
    ...
    this._card = new FilmSingleTemplate(this._film);
  ...
  _openPopup(evt) {
    evt.preventDefault();
    this._closePopups();
    this._popup = new PopupTemplate(this._film, this.onCardUpdate, this._renderCommentsToPopup);
