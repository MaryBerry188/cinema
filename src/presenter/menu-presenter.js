...
import {UserAction, ModelMethod, Category, SiteState, RenderPosition} from "../data.js";
...
export default class MenuPresenter {
  ...
  init(container = this.container) {
    ...
    this._siteMenuView = new MenuTemplate(this._filmsModel.getFilms(), this._filterModel.getFilter());
