...
import {SortType, UserAction, ModelMethod, FilmCardContainer} from "../data.js";
...
export default class BoardPresenter {
  ...
  _renderNoFilms() {
    this._noFilmsView = new NoFilmsTemplate();
  ...
  _renderSort() {
    ...
    this._siteSortView = new SortTemplate(this._currentSortType);
  ...
  _renderCatalog() {
    ...
    if (!(this._siteCatalog)) {
      this._siteCatalog = new FilmListTemplate();
    }
